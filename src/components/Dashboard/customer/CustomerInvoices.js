...
const headCells = [
  ...
  { id: 'total_amount', numeric: true, disablePadding: true, label: 'Total Amount' },
  { id: 'status', numeric: true, disablePadding: true, label: 'Status' },
  { id: 'transaction_id', numeric: true, disablePadding: false, label: 'Transaction Id' },
...
export default function CustomerInvoices(props) {
  ...
  const [rows, setCustomerOrders] = React.useState([])


  React.useEffect(() => {
    async function orders(){
      try{
        const prds = await myApi.get(`/api/store_detail/customer_orders/${props.id}/`)
        // setCustomerOrders(prds)
        console.log(prds.data,"prds")
        setCustomerOrders(prds.data)
        console.log(rows)
      }catch(err){
        alert(err)
      }
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="right">
                        ...
                        {
                          row.status == "N"?<Label color="error">NOT PAID</Label>:<Label color="success">PAID</Label>
                        }
                        {/* {row.username} */}
                      </TableCell>
